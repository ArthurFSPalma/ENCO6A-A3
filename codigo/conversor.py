...
PASTA_DADOS: Path = PASTA.parent / "dados"
ARQUIVO_PADRAO: Path = PASTA_DADOS / "PR2020.csv"
...
def converter(caminho_bruto: str | Path, caminho_saida: str | Path | None = None) -> Path:
    ...
    if caminho_saida is None:
        caminho_saida = caminho_bruto.parent / f"{caminho_bruto.stem}{SUFIXO_CONVERTIDO}.csv"
    else:
